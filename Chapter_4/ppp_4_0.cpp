...
// and test it; you may have guessed wrong about what the error is, or there may
// be more errors in a fragment than you spotted. Also, one purpose of this
...
// paste or some similar “mechanical” technique. Do not fix problems by simply
...
// cout << "Success!\n"; [15] string s = "Success!\n"; for (int i = 0; i<6; ++i)
// cout << s[i]; [16] if (true) then cout << "Success!\n"; else cout <<
